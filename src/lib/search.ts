...
function buscarPaginasEstaticas(termino: string): ResultadoBusqueda[] {
  const paginas = [
    { titulo: 'Inicio', descripcion: 'Página principal de la entidad', url: '/' },
    { titulo: 'La Entidad', descripcion: 'Información sobre la entidad', url: '/entidad' },
    { titulo: 'Misión y Visión', descripcion: 'Misión, visión y valores de la entidad', url: '/entidad/mision-vision' },
    { titulo: 'Historia', descripcion: 'Historia de la entidad', url: '/entidad/historia' },
    { titulo: 'Organigrama', descripcion: 'Estructura organizacional de la entidad', url: '/entidad/organigrama' },
    { titulo: 'Directorio', descripcion: 'Directorio de funcionarios de la entidad', url: '/entidad/directorio' },
    { titulo: 'Funciones', descripcion: 'Funciones y deberes de la entidad', url: '/entidad/funciones' },
    ...
    { titulo: 'Canales de Atención', descripcion: 'Medios para contactar a la entidad', url: '/atencion-ciudadano/canales-atencion' },
    { titulo: 'Defensoría del Pueblo', descripcion: 'Información sobre la Defensoría del Pueblo', url: '/atencion-ciudadano/defensoria' },
    { titulo: 'Servicios', descripcion: 'Catálogo de servicios de la entidad', url: '/servicios' },
    { titulo: 'Noticias', descripcion: 'Noticias y comunicados de la entidad', url: '/noticias' },
