...
export default async function ContabilidadPage() {
  ...
  const [periodos, cuentasMov, totalCuentas, ultimosComprobantes] = await Promise.all([
  ...
  const data = JSON.parse(JSON.stringify({ periodos, periodoActivo, totalCuentas, cuentasMov, ultimosComprobantes, balance }))
